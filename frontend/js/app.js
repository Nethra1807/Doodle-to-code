...
function renderResults(data) {
    ...
    // Update dynamic badge and confidence for Draw Mode too
    ...
    if (dynamicBadge && data?.label) dynamicBadge.innerText = data.label;
    if (lblConfidence && data?.confidence !== undefined) lblConfidence.innerText = `${data.confidence}%`;
    if (confBar && data?.confidence !== undefined) confBar.style.width = `${data.confidence}%`;
