...
const PromptReact = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            const htmlCode = data.html_code || data.html || data.response || "";
                ...
                <div style={{ marginTop: '1rem', padding: '1.5rem', borderTop: '1px solid rgba(99,179,237,0.15)', backgroundColor: 'var(--bg-card)', borderRadius: '12px' }}>
                     ...
                     <div className="code-block" style={{ backgroundColor: '#0d1117', padding: '1.2rem', borderRadius: '10px', overflowX: 'auto', border: '1px solid rgba(99,179,237,0.15)' }}>
                         ...
                         <pre style={{ margin: 0, color: '#e2e8f0', fontSize: '13px', lineHeight: 1.6 }}>
                             {result.react_code || result.generated_code || result.html_code || result.code || result.response || JSON.stringify(result, null, 2)}
                         </pre>
                     </div>
                     ...
                     <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
                        <button 
                            className="copy-btn" 
                            onClick={(e) => {
                                const text = result.react_code || result.generated_code || result.html_code || result.code || result.response;
                                const btn = e.target;
