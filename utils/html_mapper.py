...
<label style="display: flex; align-items: center; gap: 5px; cursor: pointer;">
  <input type="radio" style="width: 18px; height: 18px;"> Unchecked Radio
</label>
        """.strip(),
...
<label style="display: flex; align-items: center; gap: 5px; cursor: pointer;">
  <input type="radio" style="width: 18px; height: 18px;" checked> Checked Radio
        ...
        'text_area': """
<textarea style="width: 100%; height: 100px; padding: 10px; border: 1px solid #ccc; border-radius: 4px; resize: vertical;" placeholder="Enter text here..."></textarea>
        """.strip(),
        
        'checkbox_unchecked': '<label style="display: flex; align-items: center; gap: 5px; cursor: pointer;"><input type="checkbox" style="width: 18px; height: 18px;"> Checkbox Label</label>',
...
<table border="1" style="width: 100%; border-collapse: collapse; margin-top: 10px;">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="padding: 10px; border: 1px solid #ddd;">Item B</td>
